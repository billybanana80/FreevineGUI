...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        ServiceColumn.Items.AddRange(New Object() {"ABC iView", "All 4", "BBC iPlayer", "CBC Gem", "CBS", "Crackle", "CTV", "CWTV", "ITV", "My 5", "Plex", "Pluto", "Roku", "RTE Player", "STV", "SVT Play", "Tubi", "TV4 Play", "TVNZ", "UKTV Play"})
